...
public class MichiganSolutionListOutput{
	  ...
	  public MichiganSolutionListOutput setVarFileOutputContext(FileOutputContext fileContext) {
	    varFileContext = fileContext;

	    return this;
	  }

	  public MichiganSolutionListOutput setFunFileOutputContext(FileOutputContext fileContext) {
	    funFileContext = fileContext;

	    return this;
	  }

	  public MichiganSolutionListOutput setObjectiveMinimizingObjectiveList(
