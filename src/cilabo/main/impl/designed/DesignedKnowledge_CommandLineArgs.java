...
public class DesignedKnowledge_CommandLineArgs extends AbstractArgs {
	// ************************************************************
	/** データセット名 */
	...
	protected void load(String[] args) {
		...
		if(args.length < n) {
			...
			System.out.println("---");
			System.out.print(DesignedKnowledge_CommandLineArgs.getParamsString());
			System.out.println("---");
			return;
		}
		...
		experimentID = args[2];
		DesignedKnowledge_Consts.LEARNING_EXPERIMENT_ID_DIR = Consts.ROOTFOLDER + File.separator + "MixedKB" + File.separator + dataName + File.separator + experimentID;
