package cilabo.main.impl.MOEAD;
...
import cilabo.gbml.algorithm.HybridMoFGBMLwithMOEAD;
 ...
 * FAN2021時点
 */
public class MoFGBML_MOEAD_Main {
	public static void main(String[] args) throws JMetalException, FileNotFoundException {
		...
		System.out.println("main: " + MoFGBML_MOEAD_Main.class.getCanonicalName());
		String version = "1.0";
		...
		MoFGBML_MOEAD_CommandLineArgs.loadArgs(MoFGBML_MOEAD_CommandLineArgs.class.getCanonicalName(), args);
		...
		Output.writeln(fileName, MoFGBML_MOEAD_CommandLineArgs.getParamsString(), true);
		...
		/* Load Dataset ======================== */
		Input.loadTrainTestFiles_Basic(MoFGBML_MOEAD_CommandLineArgs.trainFile, MoFGBML_MOEAD_CommandLineArgs.testFile);
	...
	public static void HybridStyleMoFGBML (DataSet<Pattern_Basic> train, DataSet<Pattern_Basic> test) {
		...
		HybridMoFGBMLwithMOEAD<PittsburghSolution_Basic<MichiganSolution_Basic<Rule_Basic>>> algorithm
			= new HybridMoFGBMLwithMOEAD<PittsburghSolution_Basic<MichiganSolution_Basic<Rule_Basic>>>(problem,
											Consts.POPULATION_SIZE,
											Consts.OUTPUT_FREQUENCY,
											Consts.EXPERIMENT_ID_DIR,
											MoFGBML_MOEAD_Consts.NEIGHBORHOOD_SELECTION_PROBABILITY,
											MoFGBML_MOEAD_Consts.MAXIMUM_NUMBER_OF_REPLACED_SOLUTIONS,
											MoFGBML_MOEAD_Consts.NEIGHBORHOOD_SIZE,
											crossover,
											mutation,
											termination);
