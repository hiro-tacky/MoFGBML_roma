...
public class ObjectiveFuntion2_CommandLineArgs extends AbstractArgs {
	// ************************************************************
	/** データセット名 */
	...
	protected void load(String[] args) {
		...
		if(args.length < n) {
			...
			System.out.println("---");
			System.out.print(ObjectiveFuntion2_CommandLineArgs.getParamsString());
			System.out.println("---");
			return;
		}
		...
		experimentID = args[2];
		ObjectiveFuntion2_Consts.LEARNING_EXPERIMENT_ID_DIR = Consts.ROOTFOLDER + File.separator + "MixedKB" + File.separator + dataName + File.separator + experimentID;
